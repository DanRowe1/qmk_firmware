...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_65_ansi_blocker(
        ...
        _______, RGB_RMOD,RGB_VAD, RGB_MOD, RGB_HUD, RGB_SAD, _______, _______, _______, _______, _______, _______,          _______, KC_PSCR, \
        _______, RGB_TOG, _______, _______, _______, MD_BOOT, NK_TOGG, DBG_TOG, _______, KC_MPRV, KC_MNXT, KC_MPLY,          KC_VOLU, _______, \
        _______, _______, _______,                            _______,                            _______, _______, KC_RCTL, KC_VOLD, KC_MUTE  \
    ),
